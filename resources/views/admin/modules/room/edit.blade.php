                            ...
                            <form action="{{route('room.update',$room->id)}}" method="post"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="{{$room->roomno}}" type="text" class="form-control" id="roomno"
                                               name="roomno" placeholder="Enter Room Name">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="roomtype_id" name="roomtype_id">
                                            ...
                                            @foreach($roomtype as $items)
                                                @if($items->id == $room->roomtype_id)
                                                    <option selected
                                                            value="{{$items->id}}">{{$items->roomtypename}}</option>
                                                @else
